...
describe("binding function and object using call/apply",function(){
    it("tests rockstar and wrong with call",function(){
        assert.strictEqual(askPassword3(function(){return user2.login.call(user2,true)},function(){return user2.login.call(user2,false)},"1234"),"John failed to log in")
        assert.strictEqual(askPassword3(function(){return user2.login.call(user2,true)},function(){return user2.login.call(user2,false)},"rockstar"),"John logged in")
    });
    it("tests rockstar and wrong with apply",function(){
        assert.strictEqual(askPassword3(function(){return user2.login.apply(user2,true)},function(){return user2.login.apply(user2,false)},"1234"),"John failed to log in")
        assert.strictEqual(askPassword3(function(){return user2.login.apply(user2,true)},function(){return user2.login.apply(user2,false)},"rockstar"),"John logged in")
    })
