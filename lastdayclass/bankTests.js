...
describe("SavingsAccount", () => {
    ...
    describe("toString() method", () => {
        it("returns a string representation of the SavingsAccount", () => {
            assert.equal(savings.toString(),"SavingsAccount 1: balance 105: interest 5" );
        });
    });
...
describe("CheckingAccount", () => {
    ...
    describe("toString() method", () => {
        it("returns a string representation of the SavingsAccount", () => {
            assert.equal(checking.toString(),"CheckingAccount 1: balance -200: overdraft limit 250" );
        });
    });
    describe("endOfMonth() method", ()=>{
